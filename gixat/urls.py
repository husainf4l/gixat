...
urlpatterns = [
    ...
    path('staff/clock-in-out/', views.clock_in_out, name='clock_in_out'),
    path('staff/manage-shifts/', views.manage_shifts, name='manage_shifts'),
    path('staff/process-payroll/', views.process_payroll, name='process_payroll'),
    path('staff/add-note/', views.add_note, name='add_note'),
